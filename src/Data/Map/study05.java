...
public class study05 {
  public static void main(String[] args) {
    ...
    /* k3와 k6는 인스턴스가 다르더라도 hashCode()의 리턴 값이 같고,
     equals()의 결과가 true이기 때문에 같은 key로 간주한다.

     결론
     HashMap의 Key 객체로 사용할 클래스는 반드시 hashCode()와 equals()를 오버라이딩하여
     같은 값을 갖는 경우 같은 해시 값을 리턴하게 해야 한다.
     개발자가 만든 클래스를 key 객체로 사용하려면 이런 번거로움이 있다.
     그래서 대부분 현업에서 그냥 String을 key로 사용한다.
