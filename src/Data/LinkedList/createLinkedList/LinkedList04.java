...
public class LinkedList04<E> implements Cloneable {
  ...
  /* Object.clone()의 shallow copy 이용하여 스택 객체 복사하기
   ...
   문제점
   Node 객체들을 공유하기 때문에 Node 객체의 상태가 변경되면 원본 연결 리스트도 영향을 받는다.
   */
  @SuppressWarnings("unchecked")
  @Override
  public LinkedList04<E> clone() throws CloneNotSupportedException {
    return (LinkedList04<E>) super.clone();
  }
}
