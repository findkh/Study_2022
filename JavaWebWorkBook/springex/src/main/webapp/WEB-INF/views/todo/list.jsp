    ...
    <div class="row content">
      <div class="col">
        ...
        <div class="card">
          ...
          <div class="card-body">
            <h5 class="card-title">Special title treatement</h5>
            <table class="table">
              <thead>
                <tr>
                  <th scope="col">Tno</th>
              ...
              <c:forEach items="${responseDTO.dtoList}" var="dto">
                <tr>
                  ...
                  <td><a href="/todo/read?tno=${dto.tno}&${pageRequestDTO.link}" class="text-decoration-none">x<c:out value="${dto.title}"/></a></td>
