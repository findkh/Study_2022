...
public class ProductRepositoryTest2 {
	...
	public void basicCRUDTest() {
		...
		Assertions.assertThat(selectedProduct.getPrice()).isEqualTo(selectedProduct.getPrice());
		Assertions.assertThat(selectedProduct.getStock()).isEqualTo(selectedProduct.getStock());
