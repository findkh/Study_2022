package com.springboot.valid_exception.data.service.impl;
...
import com.springboot.valid_exception.data.service.ProductService;
...
public class ProductServiceImpl implements ProductService {
	...
	public ProductResponseDto saveProduct(ProductDto productDto) {
		LOGGER.info("[saveProducet] productDTO : {}", productDto.toString());
